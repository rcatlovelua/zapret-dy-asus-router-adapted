...
> [!IMPORTANT]
>
> Все бинарники в папке [`bin`](./bin) взяты из [zapret/releases](https://github.com/bol-van/zapret/releases) (архитектура **mipsel**) не путайте с fake -- фейки уже из discord-youtube. Вы можете проверить это с помощью хэшей/контрольных сумм.
>
